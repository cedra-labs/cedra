...
This document describes the coding guidelines for the [Aptos Core](https://github.com/cedra-labs/cedra) Rust codebase. For the Move language, see the [Move Coding Conventions](https://aptos.dev/move/book/SUMMARY).
