...
## [5.0.0] - 2024/12/11
- [**Breaking Change**] `aptos init` and `aptos account fund-with-faucet` no longer work directly with testnet, you must now use the minting page at the [Aptos dev docs](https://faucet-api.cedra.dev).
## [4.7.0] - 2024/12/10
...
## [1.0.7]
* For logs earlier than 1.0.7, please check out the [releases on GitHub](https://github.com/cedra-labs/cedra/releases?q="Aptos+CLI+Release")
