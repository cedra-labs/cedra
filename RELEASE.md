...
* When a release is ready to deploy, a [Github release page](https://github.com/cedra-labs/cedra/releases) will be created in this repo as well. You can search for the most recent release version titled with "[Mainnet]" for production usage.
