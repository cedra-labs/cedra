...
// TODO: https://github.com/cedra-labs/cedra-core/issues/2280
...
> {
    ...
    let contact = ContactObject::new()
        .name("Aptos Labs")
        .url("https://github.com/cedra-labs/cedra-core");
    ...
    OpenApiService::new(apis, "Aptos Node API", version.trim())
        ...
        .license(license)
        .contact(contact)
        .external_document("https://github.com/cedra-labs/cedra-core")
}
...
mod tests {
    ...
    // https://github.com/cedra-labs/cedra-core/issues/2977
    #[ignore]
    #[test]
