...
(
  ...
  echo "See https://github.com/cedra-labs/cedra-core-private/tree/main/protos/README.md if you're having troubles"
  cd protos/
...
echo " 1. Check out https://github.com/cedra-labs/cedra-core/blob/main/testsuite/generate-format/README.md"
