...
| fullnode.config | object | `{"full_node_networks":[{"identity":{},"inbound_rate_limit_config":null,"network_id":"public","outbound_rate_limit_config":null}]}` | Fullnode configuration. See NodeConfig https://github.com/cedra-labs/cedra-core/blob/main/config/src/config/mod.rs |
...
[REST API]: https://github.com/cedra-labs/cedra-core/blob/main/api/doc/v0/openapi.yaml
