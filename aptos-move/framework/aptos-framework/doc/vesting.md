...
<td>Audited the check for the end of vesting cliff: <a href="https://github.com/cedra-labs/cedra-core/blob/main/aptos-move/framework/aptos-framework/sources/vesting.move#L566">vest</a> module.</td>
</tr>
