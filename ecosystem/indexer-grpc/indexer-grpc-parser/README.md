...
## Tutorial
### Prerequisite
* A running PostgreSQL instance, with a valid database. More tutorial can be found [here](https://github.com/cedra-labs/cedra-core/tree/main/crates/indexer#postgres)
